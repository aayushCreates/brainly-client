  ...
  return (
    <nav className="w-full px-10 py-5 flex justify-between items-center bg-white shadow-xs border-b border-black/10 relative">
      <div>
        ...
        /> */}
        <p className="bg-blue-400/10 border border-blue-500/20 text-blue-500 px-5 py-2 rounded-md shadow-xs">BrainLY</p>
      </div>

      <div>
        <ul className="flex">
          <li className="hover:text-blue-500 hover:bg-blue-500/10 px-3 py-1 rounded-sm cursor-pointer transition-colors">Home</li>
          <li className="hover:text-blue-500 hover:bg-blue-500/10 px-3 py-1 rounded-sm cursor-pointer transition-colors">Tasks</li>
        </ul>
      </div>
